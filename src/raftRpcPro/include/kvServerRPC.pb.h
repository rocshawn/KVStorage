...
class PutAppendArgs final :
 ...
 public:
  ...
  explicit constexpr PutAppendArgs(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class PutAppendReply final :
 ...
 public:
  ...
  explicit constexpr PutAppendReply(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
